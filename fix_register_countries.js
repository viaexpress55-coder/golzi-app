...
const start = register.indexOf('COUNTRIES = [');
const end = register.indexOf('];', start) + 2;
register = register.slice(0, start) + newCountries + register.slice(end);

fs.writeFileSync('src/screens/register/RegisterScreen.tsx', register);
const count = (register.match(/code:'/g) || []).length;
console.log('Total paises:', count);