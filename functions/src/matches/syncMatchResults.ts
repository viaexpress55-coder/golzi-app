...
const NAME_MAP: Record<string, string[]> = {
  ...
  'Ivory Coast':    ["Côte d'Ivoire", 'Costa de Marfil', 'Ivory Coast', 'Costa de Marfil'],
...
export const syncMatchResults = onSchedule({
  ...
  try {
    ...
    console.log('Procesando ' + fixtures.length + ' partidos de API-Football');
