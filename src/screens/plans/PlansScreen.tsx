...
const B2C_PLANS = [
  {
    ...
    features:['Predicciones del Mundial desde el 11 jun','Ranking global GOLZI','Calendario y resultados en vivo','Participar en ligas públicas'],
    noFeatures:['Crear ligas privadas','Chat de liga','Retos diarios','Sin anuncios'],
    cta:'EMPEZAR GRATIS',
  },
  {
  ...
  },
  {
    ...
    users:10, perUser:'$1.90', saving:'5%', color:C.cyan, popular:false,
    features:['Todo lo de LIGA','Hasta 10 jugadores','Mejor experiencia grupal','Sin anuncios'],
    noFeatures:[],
    cta:'CREAR LIGA',
  },
  {
    ...
    features:['Todo lo de PRO','Hasta 25 jugadores','Historial de liga','Métricas básicas','Sin anuncios'],
    noFeatures:[],
    cta:'CREAR LIGA',
  },
  {
    id:'golzair', emoji:'🏢', name:'GOLZAIR', price:'$99.99', originalPrice:null,
    users:100, perUser:'$1.00', saving:'50%', color:C.blue, popular:false, isNew:true,
    features:['Multiligas (ilimitadas)','Hasta 100 usuarios','Dashboard básico','Chat y comunicación','Reportes básicos','Soporte prioritario'],
    noFeatures:[],
    cta:'CREAR LIGAS',
  },
];
...
const B2B_PLANS = [
  {
    ...
    users:500, perUser:'$0.70', saving:'65%', color:C.gold, popular:false,
    features:['Multiligas ilimitadas','Hasta 500 usuarios','Dashboard básico','Panel de estadísticas','Branding básico'],
    cta:'CREAR LIGAS',
  },
  {
    id:'business', emoji:'🏢', name:'BUSINESS', price:'$499.99', originalPrice:null,
    users:1000, perUser:'$0.50', saving:'75%', color:C.cyan, popular:true,
    features:['Multiligas ilimitadas','Hasta 1,000 usuarios','Dashboard avanzado','Reportes y métricas','Exportación de datos','Soporte prioritario'],
    cta:'CREAR LIGAS',
  },
  {
    id:'gold', emoji:'👑', name:'GOLD', price:'$999.99', originalPrice:null,
    users:2500, perUser:'$0.40', saving:'80%', color:C.gold, popular:false,
    features:['Multiligas ilimitadas','Hasta 2,500 usuarios','Branding personalizado','Eventos y activaciones','Soporte VIP 24/7'],
  ...
  },
  {
    ...
    features:['Todo ilimitado','White label','Integraciones avanzadas','SLA personalizado','Soporte dedicado','Escalabilidad total'],
    cta:'HABLAR CON VENTAS',
  },
];
