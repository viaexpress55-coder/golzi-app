...
const xp = StyleSheet.create({
  ...
  levelBadge:{ flexDirection:'row', alignItems:'center', gap:5, borderRadius:8, borderWidth:0.5, paddingHorizontal:10, paddingVertical:4 },
...
const s = StyleSheet.create({
  ...
  heroCard:{ margin:12, borderRadius:20, borderWidth:0.5, borderColor:'rgba(255,215,0,0.4)', overflow:'hidden', position:'relative', shadowColor:'#FFD700', shadowOffset:{width:0,height:8}, shadowOpacity:0.15, shadowRadius:16, elevation:3 },
  ...
  planBadge:{ borderRadius:8, borderWidth:0.5, borderColor:'rgba(255,215,0,0.3)', paddingHorizontal:10, paddingVertical:5 },
  planTxt:{ fontFamily:'BarlowCondensed_700Bold', fontSize:10, color:C.gold, letterSpacing:1 },
  rankBadge:{ backgroundColor:'rgba(0,255,135,0.1)', borderRadius:8, borderWidth:0.5, borderColor:'rgba(0,255,135,0.25)', paddingHorizontal:10, paddingVertical:5 },
  ...
  statCard:{ flex:1, borderRadius:14, borderWidth:0.5, borderColor:'rgba(255,215,0,0.3)', padding:10, alignItems:'center', shadowColor:'#FFD700', shadowOffset:{width:0,height:4}, shadowOpacity:0.25, shadowRadius:8, elevation:3 },
  ...
  infoCard:{ backgroundColor:'rgba(255,255,255,0.03)', borderRadius:16, borderWidth:0.5, borderColor:'rgba(255,215,0,0.25)', padding:16, shadowColor:'#FFD700', shadowOffset:{width:0,height:4}, shadowOpacity:0.2, shadowRadius:8, elevation:3 },
  ...
  notifBtn:{ backgroundColor:'rgba(255,215,0,0.06)', borderRadius:14, borderWidth:0.5, borderColor:'rgba(255,215,0,0.2)', padding:14, alignItems:'center' },
  notifTxt:{ fontFamily:'BarlowCondensed_700Bold', fontSize:13, color:C.gold, letterSpacing:1 },
  logoutBtn:{ backgroundColor:'rgba(255,51,85,0.06)', borderRadius:14, borderWidth:0.5, borderColor:'rgba(255,51,85,0.2)', padding:14, alignItems:'center' },
  logoutTxt:{ fontFamily:'BarlowCondensed_700Bold', fontSize:13, color:C.red, letterSpacing:1 },
  histRow:{ borderRadius:14, borderWidth:0.5, borderColor:'rgba(255,255,255,0.06)', flexDirection:'row', alignItems:'center', gap:12, overflow:'hidden' },
  ...
  ptsBadge:{ borderWidth:0.5, borderRadius:20, paddingHorizontal:12, paddingVertical:4, marginRight:12 },
  ...
  badgeCard:{ borderRadius:16, borderWidth:0.5, borderColor:'rgba(255,215,0,0.2)', padding:14, width:'47%', alignItems:'center', gap:6, overflow:'hidden' },
  ...
  earnedPill:{ backgroundColor:'rgba(0,255,135,0.12)', borderRadius:20, paddingHorizontal:10, paddingVertical:3, borderWidth:0.5, borderColor:'rgba(0,255,135,0.25)' },
