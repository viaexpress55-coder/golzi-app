              ...
              return (
                ...
                >
                  ...
                  <View style={[
                    ...
                    isWinner  && { backgroundColor:'rgba(255,215,0,0.12)',  borderColor:'rgba(255,215,0,0.12)' },
...
const s = StyleSheet.create({
  ...
  heroCard:{ margin:12, borderRadius:20, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.15)', overflow:'hidden', position:'relative', shadowColor:'#FFD700', shadowOffset:{width:0,height:8}, shadowOpacity:0.06, shadowRadius:2, elevation:1 },
  ...
  planBadge:{ borderRadius:8, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.12)', paddingHorizontal:10, paddingVertical:5 },
  ...
  statCard:{ flex:1, borderRadius:14, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.12)', padding:10, alignItems:'center', shadowColor:'#FFD700', shadowOffset:{width:0,height:4}, shadowOpacity:0.1, shadowRadius:3, elevation:1 },
  ...
  infoCard:{ backgroundColor:'rgba(255,255,255,0.03)', borderRadius:16, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.1)', padding:16, shadowColor:'#FFD700', shadowOffset:{width:0,height:4}, shadowOpacity:0.08, shadowRadius:3, elevation:1 },
  ...
  notifBtn:{ backgroundColor:'rgba(255,215,0,0.06)', borderRadius:14, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.1)', padding:14, alignItems:'center' },
  ...
  badgeCard:{ borderRadius:16, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.1)', padding:14, width:'47%', alignItems:'center', gap:6, overflow:'hidden' },
