...
const s = StyleSheet.create({
  ...
  heroCard:{ margin:12, borderRadius:20, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.4)', overflow:'hidden', position:'relative', shadowColor:'#FFD700', shadowOffset:{width:0,height:8}, shadowOpacity:0.4, shadowRadius:16, elevation:12 },
  ...
  statCard:{ flex:1, borderRadius:14, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.3)', padding:10, alignItems:'center', shadowColor:'#FFD700', shadowOffset:{width:0,height:4}, shadowOpacity:0.25, shadowRadius:8, elevation:6 },
  ...
  infoCard:{ backgroundColor:'rgba(255,255,255,0.03)', borderRadius:16, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.25)', padding:16, shadowColor:'#FFD700', shadowOffset:{width:0,height:4}, shadowOpacity:0.2, shadowRadius:8, elevation:5 },
