...
const pw = StyleSheet.create({
  ...
  inner:{ padding:20, alignItems:'center', gap:10, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(168,85,247,0.3)', borderRadius:20 },
  ...
  blurredAvatar:{ width:36, height:36, borderRadius:18, backgroundColor:'rgba(168,85,247,0.2)', borderWidth:StyleSheet.hairlineWidth * 2, borderColor:'rgba(168,85,247,0.4)', alignItems:'center', justifyContent:'center', marginLeft:-8 },
...
export default function RankingScreen() {
  ...
  const getCountryName = (code: string) => {
    ...
    AZ:'Azerbaiyán',BS:'Bahamas',BH:'Bahréin',BD:'Bangladesh',BB:'Barbados',
    ...
    CN:'China',CO:'Colombia',KM:'Comoras',CG:'Congo',CD:'Congo DR',
    CR:'Costa Rica',HR:'Croacia',CU:'Cuba',CY:'Chipre',CZ:'Rep. Checa',
    DK:'Dinamarca',DJ:'Yibuti',DO:'Rep. Dominicana',EC:'Ecuador',EG:'Egipto',
    SV:'El Salvador',GQ:'Guinea Ecuatorial',ER:'Eritrea',EE:'Estonia',
    SZ:'Suazilandia',ET:'Etiopía',FJ:'Fiyi',FI:'Finlandia',FR:'Francia',
    ...
    MR:'Mauritania',MU:'Mauricio',MX:'México',FM:'Micronesia',MD:'Moldavia',
    MC:'Mónaco',MN:'Mongolia',ME:'Montenegro',MA:'Marruecos',MZ:'Mozambique',
    MM:'Myanmar',NA:'Namibia',NR:'Nauru',NP:'Nepal',NL:'Países Bajos',
    NZ:'Nueva Zelanda',NI:'Nicaragua',NE:'Níger',NG:'Nigeria',MK:'Macedonia del Norte',
    NO:'Noruega',OM:'Omán',PK:'Pakistán',PW:'Palaos',PA:'Panamá',
    PG:'Papúa Nueva Guinea',PY:'Paraguay',PE:'Perú',PH:'Filipinas',PL:'Polonia',
    PT:'Portugal',QA:'Catar',RO:'Rumanía',RU:'Rusia',RW:'Ruanda',
    KN:'San Cristóbal y Nieves',LC:'Santa Lucía',VC:'San Vicente',WS:'Samoa',
    SM:'San Marino',ST:'Santo Tomé y Príncipe',SA:'Arabia Saudita',SN:'Senegal',
    ...
    AE:'Emiratos Árabes',GB:'Reino Unido',US:'USA',UY:'Uruguay',UZ:'Uzbekistán',
  ...
  // Tab 2 — Mi país
  const countrySorted = globalSorted.filter(p => p.country === myCountry);
...
const s = StyleSheet.create({
  ...
  myPosBanner:{ marginHorizontal:12, marginTop:10, borderRadius:16, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.12)', padding:14, flexDirection:'row', alignItems:'center', justifyContent:'space-between' },
  ...
  shareBtn:{ marginTop:6, backgroundColor:'rgba(255,215,0,0.1)', borderRadius:8, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.12)', paddingHorizontal:10, paddingVertical:5 },
  ...
  tab:{ flex:1, paddingVertical:8, paddingHorizontal:4, borderRadius:10, backgroundColor:'rgba(255,255,255,0.04)', alignItems:'center', borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,255,255,0.06)' },
  tabOn:{ backgroundColor:'rgba(255,215,0,0.1)', borderColor:'rgba(255,215,0,0.12)' },
  ...
  podiumPlayer:{ flex:1, alignItems:'center', gap:4, shadowOffset:{width:0,height:6}, shadowOpacity:0.06, shadowRadius:4, elevation:1 },
  ...
  playerRow:{ flexDirection:'row', alignItems:'center', marginHorizontal:12, marginBottom:6, borderRadius:14, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.15)', padding:12, gap:12, shadowColor:'#FFD700', shadowOffset:{width:0,height:3}, shadowOpacity:0.06, shadowRadius:2, elevation:1 },
  playerRowMe:{ borderColor:'rgba(255,215,0,0.5)', shadowColor:'#FFD700', shadowOpacity:0.06, elevation:1 },
  ...
  youBadge:{ backgroundColor:'rgba(255,215,0,0.15)', borderRadius:6, paddingHorizontal:6, paddingVertical:1, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.12)' },
