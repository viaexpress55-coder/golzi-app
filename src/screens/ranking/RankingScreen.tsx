...
const s = StyleSheet.create({
  ...
  myPosBanner:{ marginHorizontal:12, marginTop:10, borderRadius:16, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.3)', padding:14, flexDirection:'row', alignItems:'center', justifyContent:'space-between' },
  ...
  shareBtn:{ marginTop:6, backgroundColor:'rgba(255,215,0,0.1)', borderRadius:8, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.3)', paddingHorizontal:10, paddingVertical:5 },
  ...
  podiumPlayer:{ flex:1, alignItems:'center', gap:4, shadowOffset:{width:0,height:6}, shadowOpacity:0.15, shadowRadius:10, elevation:3 },
  ...
  playerRow:{ flexDirection:'row', alignItems:'center', marginHorizontal:12, marginBottom:6, borderRadius:14, borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(255,215,0,0.15)', padding:12, gap:12, shadowColor:'#FFD700', shadowOffset:{width:0,height:3}, shadowOpacity:0.15, shadowRadius:6, elevation:3 },
  playerRowMe:{ borderColor:'rgba(255,215,0,0.5)', shadowColor:'#FFD700', shadowOpacity:0.15, elevation:3 },
