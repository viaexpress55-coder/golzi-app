...
const pw = StyleSheet.create({
  ...
  inner:{ padding:20, alignItems:'center', gap:10, borderWidth:0.5, borderColor:'rgba(168,85,247,0.3)', borderRadius:20 },
  ...
  blurredAvatar:{ width:36, height:36, borderRadius:18, backgroundColor:'rgba(168,85,247,0.2)', borderWidth:0.5 * 2, borderColor:'rgba(168,85,247,0.4)', alignItems:'center', justifyContent:'center', marginLeft:-8 },
...
const s = StyleSheet.create({
  ...
  myPosBanner:{ marginHorizontal:12, marginTop:10, borderRadius:16, borderWidth:0.5, borderColor:'rgba(255,215,0,0.3)', padding:14, flexDirection:'row', alignItems:'center', justifyContent:'space-between' },
  ...
  shareBtn:{ marginTop:6, backgroundColor:'rgba(255,215,0,0.1)', borderRadius:8, borderWidth:0.5, borderColor:'rgba(255,215,0,0.3)', paddingHorizontal:10, paddingVertical:5 },
  ...
  tab:{ flex:1, paddingVertical:8, paddingHorizontal:4, borderRadius:10, backgroundColor:'rgba(255,255,255,0.04)', alignItems:'center', borderWidth:0.5, borderColor:'rgba(255,255,255,0.06)' },
  ...
  playerRow:{ flexDirection:'row', alignItems:'center', marginHorizontal:12, marginBottom:6, borderRadius:14, borderWidth:0.5, borderColor:'rgba(255,215,0,0.15)', padding:12, gap:12, shadowColor:'#FFD700', shadowOffset:{width:0,height:3}, shadowOpacity:0.15, shadowRadius:6, elevation:3 },
